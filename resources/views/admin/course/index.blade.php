                        ...
                        @foreach($courses as $course)
                            <tr class="{{$course->status == 1 ? '' :'bg-warning'}}">
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin.update-course-status', ['id' => $course->id])}}" class="btn btn-outline-danger" >
                                        <i class="fa fa-arrow-up"></i>
                                    </a>
                                    <a href="{{route('admin.update-course-offer-status', ['id' => $course->id])}}" class="btn btn-outline-danger" >
