                ...
                <div class="card-body">
                    ...
                    <form action="{{route('course.create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <textarea name="objective" class="form-control" id="horizontal-email-input" > </textarea>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="date" class="form-control" id="horizontal-password-input" name="startingDate"/>
                            </div>
                        </div>
