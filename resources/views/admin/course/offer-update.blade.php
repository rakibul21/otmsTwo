                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.update-course-offer',['id' => $course->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input value="{{$course->title}}" readonly type="text" class="form-control" id="horizontal-firstname-input" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input value="{{$course->fee}}" readonly type="number" class="form-control" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            <label for="horizontal-password-input4" class="col-sm-3 col-form-label">Offer Date</label>
                            <div class="col-sm-9">
